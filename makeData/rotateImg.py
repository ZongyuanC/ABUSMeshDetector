...
raw_img_path = 'G:/DOCX/GraduationProj/graduation_proj/data/Hernia Meshes/train_data/fat/'
save_img_path = 'G:/DOCX/GraduationProj/graduation_proj/data/Hernia Meshes/train_data/fat/'
    ...
    for dirpath, dirnames, filenames in os.walk(now_file_path):
        for filename in filenames:
            ...
            for i in range(1,4):
                ...
                save_file_path = os.path.join(save_img_path + fileName + '_' + str(i) + '.png')
